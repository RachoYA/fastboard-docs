# Геометрические | ClickHouse Docs

Source: https://clickhouse.com/docs/ru/sql-reference/data-types/geo
...
- Представление простых географических объектов.

## Point​

Pointзадаётся своими координатами X и Y, которые хранятся какTuple(Float64,Float64).
...
MultiLineString— это несколько линий, хранящихся в виде массиваLineString:Array(LineString).
...
MultiPolygonсостоит из нескольких полигонов и хранится как массив полигонов:Array(Polygon).
...
- Исследование масштабных реальных наборов данных: более чем 100 лет метеорологических наблюдений в ClickHouse