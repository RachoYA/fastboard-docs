...
Source: https://help.fastboard.online/user/primery-i-gaidy/marker-dinamiki-v-tablice/
...
![Создание таблицы с разрезами Категория и Название товара , добавить показатели по количеству про](https://book.winsolutions.ru/uploads/images/gallery/2026-04/embedded-image-jpt4b46r.png)
...
![Включим отображение маркера в настройках показателя “Выручка”:](https://book.winsolutions.ru/uploads/images/gallery/2026-04/embedded-image-purz6dis.png)
...
![Настроим условия для маркера . Для отрицательных значений будем выводить красный треугольник, дл](https://book.winsolutions.ru/uploads/images/gallery/2026-04/embedded-image-cefjkxwi.png)
...
![Получили таблицу с подсветкой товаров у которых отрицательная выручка:](https://book.winsolutions.ru/uploads/images/gallery/2026-04/embedded-image-x0jcqvkb.png)
