...
Source: https://help.fastboard.online/user/primery-i-gaidy/rascety-pokazatelia-na-posledniuiu-datu/
...
![Добавим их в шаблон карточки:](https://book.winsolutions.ru/uploads/images/gallery/2026-04/embedded-image-a2k7lsu3.png)
...
![Добавим их в шаблон карточки:](https://book.winsolutions.ru/uploads/images/gallery/2026-04/embedded-image-ycvqv7q6.png)
...
![Для даты найдем максимальную дату в периоде и приведем к удобному формату. Для расчета значений](https://book.winsolutions.ru/uploads/images/gallery/2026-04/embedded-image-d2lelctg.png)
...
![Получаем карточку KPI с рассчитанным значением на последнюю дату в произвольном периоде:](https://book.winsolutions.ru/uploads/images/gallery/2026-04/embedded-image-7heaurh4.png)
