...
SYSTEM_PROMPT = (
    ...
    "16. Значение переменной в правиле доступа задаётся как есть, без кавычек: "
    "кавычки в значении удвоятся и правило не сработает. В условии переменная "
    "подставляется двойными скобками.\n"
